...
public class Account_typeDAO implements DAO<Account_type> {
    ...
    public List<Mail> findAll() {
        ...
        try {
            ...
            while (rs.next()) {
                Account_type account_type = new Account_type(rs.getInt("id"), rs.getString("name"), rs.getString("code_control"));
    ...
    public Account_type findById(Integer id) {
        ...
        try {
            ...
            if (rs.next())
                account_type = new Account_type(rs.getInt("id"), rs.getString("name"), rs.getString("code_control"));
